 ...
 * @author USER
 */
public class Employee_show extends javax.swing.JFrame {

    /**
     * Creates new form Employee_show
     */
   ...
   String url = "jdbc:derby://localhost:1527/C:/derby/database";
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -1, 580, 350));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Employee_show.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Employee_show().setVisible(true);
            }
        });
    }
